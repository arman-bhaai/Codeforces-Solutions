...
// Contest ID   :: 1781
// Problem Name :: A. Parallel Projection
// Problem URL  :: https://codeforces.com/contest/1781/problem/A
// Submission   :: https://codeforces.com/contest/1781/submission/193035718
...
void solve(){
	...
	vi v={a+f+abs(b-g), (w-a)+(w-f)+abs(b-g), b+g+abs(a-f), (d-b)+(d-g)+abs(a-f)};

	cout<<*min_element(all(v))+h;
}
