...
// Problem URL  :: https://codeforces.com/contest/1433/problem/A
// Submission   :: https://codeforces.com/contest/1433/submission/191418179
...
void solve(){
	str s; cin>>s;
	cout<<int(s[0]-'1')*10 + sz(s)*(sz(s)+1)/2;
}
*/