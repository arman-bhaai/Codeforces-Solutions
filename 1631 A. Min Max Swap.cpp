...
// Contest ID   :: 1631
// Problem Name :: A. Min Max Swap
// Problem URL  :: https://codeforces.com/contest/1631/problem/A
// Submission   :: https://codeforces.com/contest/1631/submission/190614999
...
void solve(){
	...
	forn(i,n)
		if(v1[i]<v2[i])
			swap(v1[i],v2[i]);
	cout<<*max_element(all(v1))*(*max_element(all(v2)));
}
